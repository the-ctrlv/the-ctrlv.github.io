...
export const howItWorksList = [
  ...
  {
    logo: paymentsLogo,
    text: 'Quick and easy payments'
  },
  {
    logo: bankLogo,
    text: 'No more worrying about unexpected expenses'
  },
  {
    logo: heartLogo,
    text: 'Money left over goes to great causes'
  }
]

export const noDramaList = [
  {
    logo: noDramaLogo1,
    text: 'We don’t do high pressure sales calls'
  },
  {
    logo: noDramaLogo2,
    text: 'We certainly don’t send spooky letters to the elderly'
  },
  {
    logo: noDramaLogo3,
    text: 'We actually pay claims (rather than looking for excuses not to)'
  },
  {
    logo: noDramaLogo4,
    text: 'We’ll never make you traverse the dark forest – or send certified mail – to cancel your plan (in fact, you can do it in seconds online) '
  }
