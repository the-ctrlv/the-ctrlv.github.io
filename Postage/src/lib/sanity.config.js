export const sanityConfig = {
  ...
  /* When in development/working locally, it's more important to keep costs down as hot reloading can
  incurr a lot of API calls */
  ...
  apiVersion: process.env.NEXT_PUBLIC_SANITY_API_VERSION || '2022-01-09',
